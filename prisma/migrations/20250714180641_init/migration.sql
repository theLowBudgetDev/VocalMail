...
CREATE TABLE "contacts" (
    ...
    CONSTRAINT "contacts_contactUserId_fkey" FOREIGN KEY ("contactUserId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "emails" (
    ...
    CONSTRAINT "emails_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "email_recipients" (
    ...
    CONSTRAINT "email_recipients_recipientId_fkey" FOREIGN KEY ("recipientId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
